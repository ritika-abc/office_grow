                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="edit_inner_cat.php?inner_cat_id=<?php echo $row['inner_cat_id'] ?>" class="btn btn-success">Edit</a><a href="delete-inner-cat.php?inner_cat_id=<?php echo $row['inner_cat_id'] ?>" class="btn btn-danger">Delete</a></td>
                            </tr>
                        <?php
                            $sno++;
                        }
