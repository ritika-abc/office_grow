 ...
 <div class="right_col" role="main">
     ...
     <div class="row">
         ...
         <div class="col-12">
         <h4 class="my-4 text-primary">Paid Manufacturer / Supplier </h4>
             <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="my-5  d-flex">
                 <input type="search" placeholder="Search Here By Company name / Manufacturer / Supplier Name" name="search_query" class="form-control w-75 rounded float-end">
                 ...
                 <table class="table  table-striped table-success table text-capitalize">
                     ...
                     <tbody class=" ">
                         ...
                         <?php
                            ...
                            $sql = "SELECT * FROM user WHERE user_name LIKE '%" . $search_query . "%'" . " or company_name LIKE '%" . $search_query . "%'  ";
             ...
             <div class="col-12">
                 <div class="col-md-12">
                     <?php
                        ...
                        $sql = "SELECT * FROM user where  user_type = 'un-paid'   ORDER BY user_id DESC LIMIT {$offset},{$limit} ";
                        $result = mysqli_query($con, $sql) or die("Query Failed.");
                        if (mysqli_num_rows($result) > 0) {
                        ?>
                      <div class="w-100 " style="overflow-y:auto">
                             <table class="table  table-striped table-light table  " style="width:2000px">
                             <thead>
                                 <tr>
                     ...
                     <?php
                        ...
                        if (mysqli_num_rows($result1) > 0) {
                            ...
                            if ($page > 1) {
                                echo '<li class="page-item"><a class="page-link" href="add-paid-clents.php?page=' . ($page - 1) . '">Prev</a></li>';
                            }
                            for ($i = 1; $i <= $total_page; $i++) {
                                ...
                                echo '<li class="page-item' . $active . '"><a class="page-link"  href="add-paid-clents.php?page=' . $i . '">' . $i . '</a></li>';
                            }
                            if ($total_page > $page) {
                                echo '<li class="page-item"><a class="page-link" href="add-paid-clents.php?page=' . ($page + 1) . '">Next</a></li>';
                            }
