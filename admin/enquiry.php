...
?>
<!-- page content -->
<div class="right_col bg-white  " style="min-height: 100vh;"  >
    <!-- top tiles -->
    <div class="row">
        <div class="col-12">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="my-5  d-flex">
                <input type="search" placeholder="Email / Enquiry" name="search_query" class="form-control w-75 rounded float-end">
        ...
        ?>
            ...
            <div class="col-12 my-4">
                <table class="table  table-striped table-success table ">
                    ...
                    <tbody class=" ">
                        ...
                        $sql = "SELECT * FROM  `enquiry` WHERE buyer_email LIKE '%" . $search_query . "%'" . " or enquiry_for LIKE '%" . $search_query . "%'";
            ...
            <div class="col-12">
                ...
                <div class="col-md-12">
                    ...
                    $sql = "SELECT * FROM  `enquiry` ORDER BY id DESC LIMIT {$offset},{$limit}";
                    ...
                    if (mysqli_num_rows($result1) > 0) {
                        ...
                        if ($page > 1) {
                            echo '<li class="page-item"><a class="page-link" href="enquiry.php?page=' . ($page - 1) . '">Prev</a></li>';
                        }
                        for ($i = 1; $i <= $total_page; $i++) {
                            ...
                            echo '<li class="page-item' . $active . '"><a class="page-link"  href="enquiry.php?page=' . $i . '">' . $i . '</a></li>';
                        }
                        if ($total_page > $page) {
